...
**Build-orchestrator detection protocol after each builder:**
...
3. **Build-orchestrator checks SUMMARY.md** after EVERY builder finishes -- this is mandatory, not optional
