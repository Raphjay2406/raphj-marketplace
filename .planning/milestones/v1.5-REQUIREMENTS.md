# Requirements Archive: v1.5 SEO/GEO & API Integration
...
| Feature | Reason |
|---------|--------|
| SEO keyword research tools | Genorah generates code, not marketing strategy |
...
| Full backend API development | Genorah handles API routes for external wiring, not custom business logic |
| SEO A/B testing infrastructure | Too complex for v1.5, defer to v2 |
| Paid search / SEM integration | Advertising is not Genorah's domain |
...
**Shipped:** 40 of 40 v1.5 requirements
