 ...
 */
export function NoiseBackdrop({ intensity = 0.4, blurPx = 12, className, children, }) {
    ...
    if (!gpuAvailable) {
        ...
        return (_jsxs("div", { className: className, "data-webgpu-effect": "noise-backdrop", "data-fallback": "css", style: {
                position: "relative",
    ...
    return (_jsxs("div", { className: className, "data-webgpu-effect": "noise-backdrop", "data-fallback": "gpu", style: { position: "relative" }, children: [_jsx("canvas", { ref: canvasRef, "aria-hidden": true, style: { position: "absolute", inset: 0, width: "100%", height: "100%", pointerEvents: "none" } }), children] }));
}
